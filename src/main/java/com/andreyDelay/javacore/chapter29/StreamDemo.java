...
public class StreamDemo {
    public static void main(String[] args) {
        ...
        //поток элементов списочного масива
        ...
        //предыдущий вызов метода min() был терминальной операцией
        ...
        //отобразить отсортированный stream методом forEach()
        System.out.print("Отсортированный поток данных: ");
        sortedStream.forEach((n) -> System.out.print(n + " "));
        System.out.println();

        //вывести только нечётные целочистленные значения

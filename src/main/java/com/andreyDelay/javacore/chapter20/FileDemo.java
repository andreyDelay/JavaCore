...
public class FileDemo {
    ...
    public static void main(String[] args) {
        File f1 = new File("C:\\Users\\Я\\IdeaProjects\\javacore\\src\\main\\java\\com\\andreyDelay\\javacore\\chapter20\\Новый текстовый документ.txt");
        ...
        p("Free space: " + f1.getFreeSpace() / 1024);
    }
}
